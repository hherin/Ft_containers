...
namespace ft
{
	...
	class map
	{
		public:
			...
			typedef typename ft::map_bidirect_iter<T, true, s_abr<key_type, mapped_type> >	iterator;
			typedef typename ft::map_bidirect_iter<T, false, s_abr<key_type, mapped_type> >	const_iterator;
		...
		private :
			s_abr<key_type, mapped_type> *root;
			size_type _size;
			s_abr<key_type, mapped_type> *neutral;
